...
- [Swagger firos API endpoints reference](https://swagger.lab.fiware.org/?url=https://raw.githubusercontent.com/Fiware/specifications/master/OpenAPI/ngsiv2/ngsiv2-openapi.json#/)## Installation
```
# Create a new ROS workspace
mkdir -p catkin_ws/src && cd catkin_ws/src
